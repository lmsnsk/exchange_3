...
"}"));
        ...
        QWidget::setTabOrder(loanAmountInput, timeInput);
        QWidget::setTabOrder(timeInput, rateInput);
        QWidget::setTabOrder(rateInput, equalRBtn);
        QWidget::setTabOrder(equalRBtn, differentRBtn);
        QWidget::setTabOrder(differentRBtn, calculateButton);
